...
INSERT INTO public.tournament_course_rounds(
	...
	('60564d85-f3d2-4dd8-b3e6-098495888d52', (SELECT id FROM public.courses WHERE name = 'CT National'), (SELECT id FROM public.tournament_courses WHERE tournament_id = (SELECT id FROM public.tournaments LIMIT 1) AND "order" = 5), 1, 9, 8, '7-19-2025', '8-2-2025', (SELECT id FROM public.tournaments LIMIT 1))
	;